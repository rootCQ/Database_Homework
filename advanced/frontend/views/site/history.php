...
<div id="hiswrapper">
    ...
    <!-- hisitems -->
        <section class="hismain items">
            ...
            <p>
            <h3><font size=5 color='#7E0C6E'face="verdana">始于1919</font></h3>
            ...
            <article class="hisitem">
                <header>
                    <a href="#"><img src="statics/img/history/NKU_2.jpg" alt="" /></a>
                     ...
                     <h3><font size=5 color='#7E0C6E'face="verdana">水田风光</font></h3>
  <p><font size=3 color='#7E0C6E'face="verdana">
三十年代初，南开大学是有名的风景游览区。<br />
            ...
            <article class="hisitem">
                <header>
                    <a href="#"><img src="statics/img/history/NKU_1.jpg" alt="" /></a>
                     ...
                     <h3><font size=5 color='#7E0C6E'face="verdana">私立时期</font></h3>
  <p><font size=3 color='#7E0C6E'face="verdana">
南开大学孕育于新文化运动，诞生于五四运动。<br />
            ...
            <article class="hisitem">
                <header>
                    <a href="#"><img src="statics/img/history/NKU_2.jpg" alt="" /></a>
                     ...
                     <h3><font size=5 color='#7E0C6E'face="verdana">西南联大</font></h3>
  <p><font size=3 color='#7E0C6E'face="verdana">
华北事变后，形势日趋紧张。日军向天津进攻。<br />
