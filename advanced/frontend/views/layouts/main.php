                ...
                <div class="row align-items-center justify-content-between d-flex">
                    ...
                    <nav id="nav-menu-container">
                        ...
                        <li><a href="<?php echo Url::to(['site/index']);?>"><img src="statics/img/home.ico" height="25" width="25" alt="">Home</a></li>
                            ...
                            <li><a href="<?php echo Url::to(['site/newsdetail']); ?>"><img src="statics/img/activities.ico" height="20" width="20" alt="">Activities</a></li>
                            <li><a href="<?php echo Url::to(['site/shop']); ?>"><img src="statics/img/bag.ico" height="17" width="17" alt="">Souvenirs</a></li>
                            <li><a href="<?php echo Url::to(['site/messages']); ?>"><img src="statics/img/about.ico" height="20" width="20" alt="">Messages</a></li>
