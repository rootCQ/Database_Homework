				...
				<ul class="portfolio-list portfolio-4col">
					<li>
						...
						<div class="desc">
							...
							<a href="payment.php?new=南开风景明信片" get class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li> 
						...
						<div class="desc">
							<a href="payment.php?new=学位熊" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li> 
						...
						<div class="desc">
							<a href="payment.php?new=阳阳与亮亮" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li> 
						...
						<div class="desc">
							<a href="payment.php?new=校徽" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li>
						...
						<div class="desc">
							<a href="payment.php?new=口红套装" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li> 
						...
						<div class="desc">
							<a href="payment.php?new=保温杯" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li>
						...
						<div class="desc">
							<a href="payment.php?new=荷花木雕水杯垫" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
					...
					<li> 
						...
						<div class="desc">
							<a href="payment.php?new=兔子玩偶" class="btn btn-sm btn-primary"><i class="icon icon-basket"></i>Buy</a>
