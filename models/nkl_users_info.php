 ...
 */
class nkl_users_info extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(NklBbsSelectrecord::className(), ['user_id' => 'user_id']);
    }
    ...
    {
        return $this->hasMany(NklNewsCommentsSelectrecord::className(), ['user_id' => 'user_id']);
    }
